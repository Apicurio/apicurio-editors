...
import { ApicurioEditor } from "./ApicurioEditor";

export class ApicurioEditorInterface implements Editor {
  private editorRef: RefObject<EditorApi>;
  public af_isReact = true;
  public af_componentId = "apicurio-editor";
  public af_componentTitle = "Apicurio Editor";
